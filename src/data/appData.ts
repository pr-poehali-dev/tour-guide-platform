...
export const lostItems = [
  {
    ...
    description: 'Потерял телефон в районе Артёма, около Донецкого университета. В чехле была банковская карта.',
    location: 'Бульвар Пушкина',
    date: '26 янв',
    emoji: '📱'
  },
  {
    ...
    description: 'Нашли рыжего кота около Донецкого музыкального театра. Очень ласковый, в ошейнике, но без бирки.',
    location: 'Театральная пл.',
    date: '25 янв',
    emoji: '🐱'
  },
  {
    ...
    description: 'Утерян кожаный кошелёк коричневого цвета в парке имени Щербакова. Внутри документы на имя Иванов А.С.',
    location: 'Парк Щербакова',
    date: '24 янв',
    emoji: '👛'
  },
  {
    ...
    description: 'Найдены ключи от машины с брелоком BMW около ТРК "Донецк Сити". На связке 4 ключа.',
    location: 'ТРК "Донецк Сити"',
    date: '23 янв',
    emoji: '🔑'
  },
  {
  ...
  },
  {
    ...
    description: 'На площади Ленина найден ребёнок примерно 5-6 лет, мальчик в синей куртке. Находится в полиции.',
  ...
  },
  {
    ...
    description: 'Нашла очки в футляре около Спасо-Преображенского собора. Футляр серого цвета, очки в тонкой оправе.',
    location: 'Спасо-Преображенский собор',
    date: '24 янв',
    emoji: '👓'
  }
];
...
export const events = [
  {
    ...
    dateTime: '2026-01-28',
    time: '10:00 - 20:00',
    location: 'Донецкий художественный музей',
    locationId: 1,
    price: 'от 600 ₽',
    image: '🎨',
    verified: true,
  ...
  },
  {
    ...
    dateTime: '2026-01-30',
    time: '18:30',
    location: 'Донецкий драматический театр',
    locationId: null,
    price: 'от 1500 ₽',
    image: '🎭',
    verified: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 567,
    description: 'Грандиозное световое шоу на площади Ленина. Проекции на фасады зданий.',
    distance: '0.8 км'
  },
  {
    id: 5,
...
export const objects = [
  {
    id: 1,
    name: 'Донецкий художественный музей',
    category: 'Музей',
    rating: 4.9,
    reviews: 2847,
    distance: '1.2 км',
  ...
  },
  {
    ...
    image: '🌳',
    audioAvailable: true,
    description: 'Крупный парк в центре Донецка с живописными аллеями и зонами отдыха.',
  },
  {
    id: 3,
    name: 'Ресторан "Донбасс"',
    category: 'Ресторан',
    rating: 4.8,
    reviews: 892,
    distance: '0.3 км',
    ...
    description: 'Популярный ресторан с классической кухней и уютной атмосферой.',
  },
];
...
export const routes = [
  {
    ...
    isFavorite: false,
    points: [
      { id: 1, name: 'Площадь Ленина', time: '30 мин', emoji: '🏛️' },
      { id: 2, name: 'Художественный музей', time: '90 мин', emoji: '🎨' },
      { id: 3, name: 'Бульвар Пушкина', time: '45 мин', emoji: '🚶' },
      { id: 4, name: 'Спасо-Преображенский собор', time: '20 мин', emoji: '⛪' },
      { id: 5, name: 'Памятник Шевченко', time: '30 мин', emoji: '🗿' },
      { id: 6, name: 'Парк Форжа', time: '15 мин', emoji: '🌳' },
      { id: 7, name: 'Парк Щербакова', time: '30 мин', emoji: '🌿' },
      { id: 8, name: 'Оперный театр', time: '20 мин', emoji: '🎭' }
    ]
  },
  {
    id: 2,
    title: 'Романтика Донецка',
    ...
    isFavorite: true,
    points: [
      { id: 1, name: 'Парк Форжа', time: '20 мин', emoji: '🌹' },
      { id: 2, name: 'Площадь Ленина', time: '30 мин', emoji: '🏛️' },
      { id: 3, name: 'Набережная Кальмиуса', time: '40 мин', emoji: '🌊' },
      { id: 4, name: 'Оперный театр', time: '45 мин', emoji: '🎭' },
      { id: 5, name: 'Ботанический сад', time: '30 мин', emoji: '🌺' },
      { id: 6, name: 'Парк Щербакова', time: '25 мин', emoji: '🌳' }
    ]
  },
  {
    id: 3,
    title: 'Исторический Донецк',
    description: 'Маршрут по историческим местам города',
    duration: '5-6 часов',
    distance: '10.3 км',
    difficulty: 'Средний',
    image: '📚',
    ...
    isFavorite: false,
    points: [
      { id: 1, name: 'Площадь Ленина', time: '25 мин', emoji: '🏛️' },
      { id: 2, name: 'Памятник Шевченко', time: '20 мин', emoji: '🗿' },
      { id: 3, name: 'Бульвар Пушкина', time: '30 мин', emoji: '🚶' },
      { id: 4, name: 'Художественный музей', time: '60 мин', emoji: '🎨' },
      { id: 5, name: 'Музей истории', time: '45 мин', emoji: '📖' },
      { id: 6, name: 'Оперный театр', time: '30 мин', emoji: '🎭' },
      { id: 7, name: 'Парк Форжа', time: '30 мин', emoji: '🌳' },
      { id: 8, name: 'Мемориальный комплекс', time: '25 мин', emoji: '⛪' },
      { id: 9, name: 'Стадион Шахтёр', time: '20 мин', emoji: '⚽' },
      { id: 10, name: 'Ботанический сад', time: '35 мин', emoji: '🌺' }
    ]
  },
  {
    id: 4,
    ...
    isFavorite: true,
    points: [
      { id: 1, name: 'Ресторан "Донбасс"', time: '90 мин', emoji: '☕' },
      { id: 2, name: 'Кафе "Шахтёр"', time: '120 мин', emoji: '🍴' },
      { id: 3, name: 'Пекарня "Булочная"', time: '20 мин', emoji: '🥐' },
      { id: 4, name: 'Кондитерская "Сладкий дом"', time: '60 мин', emoji: '🍰' },
      { id: 5, name: 'Ресторан "Украина"', time: '90 мин', emoji: '🥞' }
    ]
  },
  {
    id: 5,
